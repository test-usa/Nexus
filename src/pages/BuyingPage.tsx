...
const BuyingPage = () => {
  ...
  const handleDescres = () => setCount((prev) => Math.max(1, prev - 1));
  const handleIncres = () => setCount((prev) => prev + 1);
  ...
  return (
    <div className="min-h-screen bg-[#212020] flex items-center justify-center p-6">
      <div className="flex flex-col sm:flex-row  justify-center w-full max-w-5xl gap-8 rounded-lg p-6">
        ...
        <div className=" w-full  sm:max-w-lg border p-6  rounded-2xl shadow-lg shadow-gray-600 ">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4 text-gray-200">New Key</h2>
          ...
          <div className="space-y-3">
            <div className="mb-4">
              <label htmlFor="keyType" className="block text-xs text-gray-500 mb-2">
                Select one*
              </label>
              <select
                id="keyType"
                className="w-full bg-cyan-800/50 text-white py-2.5 px-2 rounded-md focus:outline-none"
              >
            ...
            <div className="flex items-center gap-x-5">
              <Button
                ...
                className="bg-gray-200 hover:bg-gray-300 sm:w-10 w-6 sm:h-10 h-8 text-black text-xl"
              >
                -
              </Button>
            ...
            <div className="space-y-3">
              <h1 className="text-sm font-semibold text-gray-200">Subtotal</h1>
              <p className="text-xs text-gray-500">
                Total will be calculated at checkout
              </p>
            </div>

            <button className="w-full text-[16px] sm:text-lg bg-cyan-800/50 rounded-md py-2  text-white focus:outline-none">
              Checkout
            </button>
          </div>
        </div>
