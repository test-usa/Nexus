  ...
  return (
    <div className="flex">
      ...
      <button className="md:hidden p-4" onClick={() => setToggle(!toggle)}>
        {toggle ? (
          <GoX className="text-3xl cursor-pointer text-white" />
        ) : (
          <FcMenu className="text-3xl cursor-pointer text-gray-400" />
        )}
      </button>
      ...
      <motion.aside
        ...
        animate={{
          opacity: toggle ? 1 : 1, // Keep visible for large screens, toggle on small
          x: toggle ? 0 : 0, // No horizontal movement for large screens
        }}
        transition={{ duration: 0.3, ease: "easeInOut" }}
        className="md:flex w-96 flex-col border-r bg-white px-12"
      >
    ...
    <div className="flex">
      ...
      >
        {toggle ? (
          ...
          <FcMenu className="text-3xl text-gray-400" />
        )}
      </button>
      ...
      <motion.aside
        ...
        transition={{ duration: 0.3, ease: "easeInOut" }}
        className="md:flex w-72 flex-col bg-gradient-to-r from-gray-800 to-gray-900 text-white border-r p-6 shadow-lg"
      >
