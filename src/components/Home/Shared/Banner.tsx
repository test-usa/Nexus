...
import { useTime, useTransform, motion, useInView } from "framer-motion";
...
const Banner = () => {
  ...
  const rotateBg = useTransform(rotate, (r) => {
    return `conic-gradient(from ${r}deg, #7f5af0, #2cb67d, #7f5af0)`;
  });
