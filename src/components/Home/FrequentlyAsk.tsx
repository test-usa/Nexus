...
export function FrequentlyAsk() {
  ...
  return (
    <Element name="FAQ" className=" relative z-30 bg-[#182029] ">
      <CommonWrapper>
        <div className="mt-10 ">
          {" "}
          <Title
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              >
                ...
                <AccordionContent className="text-[var(--color-textsecondarycolor)] text-sm sm:tex-md">
                  Exodus is not detectable by Edgenuity, and you cannot get
                  caught using Exodus as long as you use safe delays.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-2"
              ...
              >
                ...
                <AccordionContent className="text-[var(--color-textsecondarycolor)] text-sm sm:tex-md">
                  ...
                  These bots handle repetitive tasks like skipping videos,
                  answering quiz questions, and advancing lessons, making online
              ...
              >
                ...
                <AccordionContent className="text-[var(--color-textsecondarycolor)] text-sm sm:tex-md">
                  ...
                  Cryptocurrency, etc. Please open a ticket on our Discord
                  server for alternative payment methods.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem
                value="item-4"
