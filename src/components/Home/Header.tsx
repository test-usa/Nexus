  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#212020] px-6">
      <div className="text-center max-w-3xl">
        ...
        <div className="mt-8">
          <button className="px-6 py-3 text-lg font-semibold text-white border-2 border-gray-500 rounded transition duration-300 hover:text-white translate transform  bg-slate-800 hover:bg-slate-500 ">
            Buy Now
          </button>
        </div>
      </div>
